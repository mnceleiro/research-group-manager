import { REQUEST_JOURNALS, RECEIVE_JOURNALS, REQUEST_BOOK, RECEIVE_BOOK,
...
const initialState = {
  ...
  table: {
    headers: ["Código", "Título", "Revista", "Volumen", "Editorial", "Lugar"],
    fields: ["code", "title", "journal", "volume", "editorial", "place"],
    editable: true
  }
}
...
export default function objects(state = initialState, action) {
  ...
  case ADD_BOOK_SUCCESS:
    return Object.assign({}, state, {
      isFetching: false,
      error: null,
      success: "El revista ha sido creado correctamente."
    })
  ...
  case UPDATE_BOOK_SUCCESS:
    return Object.assign({}, state, {
      isFetching: false,
      error: null,
      success: "El revista ha sido actualizado correctamente."
    })
  ...
  case DELETE_BOOK_SUCCESS:
    return Object.assign({}, state, {
      isFetching: false,
      error: null,
      success: "El revista ha sido eliminado correctamente."
    })
